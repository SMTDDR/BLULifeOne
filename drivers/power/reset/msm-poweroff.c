...
//LINE<JIRA_ID><DATE20141208><forbid download mode>zenghaihui
...
static void msm_restart_prepare(const char *cmd)
{
	...
	if (qpnp_pon_check_hard_reset_stored()) {
		/* Set warm reset as true when devide is in dload mode
...
//yangliang mask "static" for charger and shutdown without battery
//<BEGIN><FFBAKK-105><2014.01.20>add static again for factory using without batt;yangliang
