...
static char camera_id[INFO_LEN];//Begin<REQ><JABAL-1500><20150608>add camera_id;xiongdajun
#if 0
...
//Begin<REQ><JABAL-1500><20150608>add camera_id;xiongdajun
static ssize_t camera_id_show(struct kobject *kobj, struct kobj_attribute *attr,
		      char *buf)
{
	CDBG("%s : camera_id=%s\n", __func__, camera_id);
	return snprintf(buf, INFO_LEN, "%s\n", camera_id);
}
static ssize_t camera_id_store(struct kobject *kobj, struct kobj_attribute *attr,
		      const char *buf, size_t count)
{
	CDBG("%s : buf=%s\n", __func__, buf);
	return snprintf(camera_id, INFO_LEN, "%s\n", buf);
}
//End<REQ><JABAL-1500><20150608>add camera_id;xiongdajun
#if 0
...
//Begin<REQ><JABAL-1500><20150608>add camera_id;xiongdajun
static struct kobj_attribute camera_id_attribute =
	__ATTR(camera_id, 0644, camera_id_show, camera_id_store);
//End<REQ><JABAL-1500><20150608>add camera_id;xiongdajun
...
static struct attribute *attrs[] = {
	...
	&camera_id_attribute.attr,//Begin<REQ><JABAL-1500><20150608>add camera_id;xiongdajun
#if 0	
